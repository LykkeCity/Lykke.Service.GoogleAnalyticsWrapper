...
autorest --input-file=http://localhost:5000/swagger/v1/swagger.json --csharp --output-folder=./client/Lykke.Service.GoogleAnalyticsWrapper.Client/AutorestClient --namespace=Lykke.Service.GoogleAnalyticsWrapper.Client.AutorestClient